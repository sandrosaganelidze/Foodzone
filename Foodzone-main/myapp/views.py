...
from .models import Contact, Dish, Team, Category, Profile, Order, Reservation
...
def all_reservations(request):
    ...
    # Check if query parameter "q" is present in the request
    if "q" in request.GET:
        id = request.GET.get("q")
        reservations = Reservation.objects.filter(category__id=id)
        # You need to adjust this line according to your model structure
        # context['reservation_category'] = Category.objects.get(id=id).name
